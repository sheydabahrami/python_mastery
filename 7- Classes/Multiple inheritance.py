...
# If not used properly it will create bugs in the program
...
# It is better to use multiple Inheritance, with small classes that have nothing in common.
...
class Swimmer: # here we are setting a class and creating a feature for swiming
    def swim(self):
        pass


class FlyingFish(Flyer, Swimmer): # So the FlyingFish class can inherit the features from the Flyer and Swimer classes.
    pass