...
# To avoid reapeting the same method in several classes we can use inheritance (DRY: DONT REPEAT YOURSELF)
# It is a mechanism that allows us to define the common functions in one classes and then inherit them to other classes
